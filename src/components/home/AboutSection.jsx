...
function AboutSection() {
  ...
  return (
    <section className="py-12 md:py-20 bg-transparent dark:bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.h2 
            className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-gray-900 via-primary to-blue-600 dark:from-gray-100 dark:via-blue-400 dark:to-blue-500 bg-clip-text text-transparent px-4"
          ...
          <motion.div 
            className="w-20 md:w-24 h-1 bg-gradient-to-r from-primary to-blue-600 dark:from-blue-400 dark:to-blue-500 mx-auto rounded-full mb-6 md:mb-8"
            initial={{ width: 0 }}
          ...
          <motion.div 
            className="max-w-3xl mx-auto space-y-4 md:space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed px-4"
            initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12 md:mt-16 px-4 md:px-0">
          {features.map((feature, index) => (
            ...
            >
              <motion.div
                className="bg-white dark:bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-800 relative overflow-hidden"
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-gray-900 dark:text-white relative z-10">
                  {feature.title}
                </h3>
                
                <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 leading-relaxed relative z-10">
                  {feature.description}
                </p>

                {/* Decorative element */}
                <motion.div
                  className="absolute top-0 right-0 w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-primary/20 dark:from-blue-500/30 to-transparent rounded-bl-full"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
